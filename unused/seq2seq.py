...
class NMTDataset:
    def __init__(self, problem_type='zh-zh'):
    ...
    def create_dataset(self, path, num_examples):
        ...
        qpath="./data/q_data.txt"
        apath="./data/a_data.txt"
        ...
        for i in range(len(qlines)):
            qline='<start>\t' + qlines[i].strip() + '\t<end>'
            aline='<start>\t' + alines[i].strip() + '\t<end>'
            word_pairs.append([qline,aline])
    ...
    def call(self, num_examples, BUFFER_SIZE, BATCH_SIZE):
        ...
        file_path = "./models/train_data.txt"
